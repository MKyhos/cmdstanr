...
#>   seed = 1702622625
#> output
#>   file = /tmp/RtmpnCkjs2/logistic-202604022132-1-2db1d5.csv
#>   diagnostic_file =  (Default)
#>   refresh = 100 (Default)
#>   sig_figs = 8 (Default)
#>   profile_file = /tmp/RtmpnCkjs2/logistic-profile-202604022132-1-07c87c.csv
...
#>   seed = 327235529
#> output
#>   file = /tmp/RtmpnCkjs2/logistic-202604022132-1-1353c3.csv
#>   diagnostic_file =  (Default)
#>   refresh = 100 (Default)
#>   sig_figs = 8 (Default)
#>   profile_file = /tmp/RtmpnCkjs2/logistic-profile-202604022132-1-8f4617.csv
#>   save_cmdstan_config = false (Default)
#> num_threads = 1 (Default)
#> 
...
#>   seed = 1293992464
#> output
#>   file = /tmp/RtmpnCkjs2/logistic-202604022132-1-5162d4.csv
#>   diagnostic_file =  (Default)
#>   refresh = 100 (Default)
#>   sig_figs = 8 (Default)
#>   profile_file = /tmp/RtmpnCkjs2/logistic-profile-202604022132-1-538f10.csv
#>   save_cmdstan_config = false (Default)
#> num_threads = 1 (Default)
#> 
#> ------------------------------------------------------------
