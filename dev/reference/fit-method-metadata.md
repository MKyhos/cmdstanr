...
#>  $ start_datetime      : chr "2026-04-02 21:32:53 UTC"
#>  $ method              : chr "sample"
#>  $ save_warmup         : int 0
#>  $ thin                : num 1
#>  $ gamma               : num 0.05
...
#>  $ refresh             : num 100
#>  $ sig_figs            : num 8
#>  $ profile_file        : chr "/tmp/RtmpnCkjs2/logistic-profile-202604022132-1-3e3439.csv"
...
#>  $ step_size_adaptation: num [1:4] 0.71 0.709 0.797 0.735
...
#>   ..$ warmup  : num [1:4] 0.018 0.018 0.019 0.019
#>   ..$ sampling: num [1:4] 0.056 0.056 0.052 0.055
#>   ..$ total   : num [1:4] 0.074 0.074 0.071 0.074
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/RtmpnCkjs2/logistic-profile-202604022132-1-02b82d.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.38.0"
...
#>  $ stan_version_minor : num 38
#>  $ stan_version_patch : num 0
#>  $ start_datetime     : chr "2026-04-02 21:32:54 UTC"
...
#>  $ refresh            : num 100
#>  $ sig_figs           : num 8
#>  $ profile_file       : chr "/tmp/RtmpnCkjs2/logistic-profile-202604022132-1-679305.csv"
#>  $ save_cmdstan_config: int 0
#>  $ stanc_version      : chr "stanc3 v2.38.0"
#>  $ sampler_diagnostics: chr(0) 
