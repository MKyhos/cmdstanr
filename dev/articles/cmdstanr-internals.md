...
```
    ...
    [1] "/home/runner/.cmdstan/cmdstan-2.38.0/examples/bernoulli/bernoulli.stan"
...
Warning in '/tmp/Rtmpwt5M8M/model-3af3468ab5ec.stan', line 8, column 2 to column 14:
    The parameter lambda has no priors. This means either no prior is
    provided, or the prior(s) depend on data variables. In the later case,
    this may be a false positive.
Warning in '/tmp/Rtmpwt5M8M/model-3af3468ab5ec.stan', line 11, column 14 to column 20:
...
Warning in '/tmp/Rtmpwt5M8M/model_febb1e69c7387a0e64cf13583e078104.stan', line 8, column 2 to column 14:
    The parameter lambda has no priors. This means either no prior is
    provided, or the prior(s) depend on data variables. In the later case,
    this may be a false positive.
Warning in '/tmp/Rtmpwt5M8M/model_febb1e69c7387a0e64cf13583e078104.stan', line 11, column 14 to column 20:
    A poisson distribution is given parameter lambda as a rate parameter
    (argument 1), but lambda was not constrained to be strictly positive.
...
```
    ...
    [1] "/tmp/Rtmpwt5M8M/bernoulli-202604022138-1-5be62b.csv"
    [2] "/tmp/Rtmpwt5M8M/bernoulli-202604022138-2-5be62b.csv"
    [3] "/tmp/Rtmpwt5M8M/bernoulli-202604022138-3-5be62b.csv"
    [4] "/tmp/Rtmpwt5M8M/bernoulli-202604022138-4-5be62b.csv"
...
```
    ...
    Ncells 1224486 65.4    2519021 134.6  1598012 85.4
    Vcells 2127374 16.3    8388608  64.0  4902342 37.5
...
```
    ...
    List of 8
     $ metadata                       :List of 42
      ...
      ..$ start_datetime      : chr "2026-04-02 21:38:24 UTC"
      ..$ method              : chr "sample"
      ..$ save_warmup         : int 0
      ..$ thin                : num 1
      ..$ gamma               : num 0.05
      ...
      ..$ refresh             : num 100
      ..$ sig_figs            : num 8
      ..$ profile_file        : chr "/tmp/Rtmpwt5M8M/bernoulli-profile-202604022138-1-2c71fb.csv"
...
```
    ...
    [1] "/tmp/Rtmpwt5M8M/bernoulli-diagnostic-202604022138-1-057480.csv"
    [2] "/tmp/Rtmpwt5M8M/bernoulli-diagnostic-202604022138-2-057480.csv"
    [3] "/tmp/Rtmpwt5M8M/bernoulli-diagnostic-202604022138-3-057480.csv"
    [4] "/tmp/Rtmpwt5M8M/bernoulli-diagnostic-202604022138-4-057480.csv"
...
```
    ...
    Running make /tmp/Rtmpwt5M8M/model-3af3211dcec4 \
      "STANCFLAGS +=  --name='bernoulli_model'"

    --- Translating Stan model to C++ code ---
    bin/stanc --name='bernoulli_model' --o=/tmp/Rtmpwt5M8M/model-3af3211dcec4.hpp /tmp/Rtmpwt5M8M/model-3af3211dcec4.stan

    --- Compiling C++ code ---
    g++ -Wno-deprecated-declarations -std=c++17 -pthread -D_REENTRANT -Wno-sign-compare -Wno-ignored-attributes -Wno-class-memaccess      -I stan/lib/stan_math/lib/tbb_2020.3/include    -O3 -I src -I stan/src -I stan/lib/rapidjson_1.1.0/ -I lib/CLI11-1.9.1/ -I stan/lib/stan_math/ -I stan/lib/stan_math/lib/eigen_3.4.0 -I stan/lib/stan_math/lib/boost_1.87.0 -I stan/lib/stan_math/lib/sundials_6.1.1/include -I stan/lib/stan_math/lib/sundials_6.1.1/src/sundials    -DBOOST_DISABLE_ASSERTS          -c -Wno-ignored-attributes   -x c++ -o /tmp/Rtmpwt5M8M/model-3af3211dcec4.o /tmp/Rtmpwt5M8M/model-3af3211dcec4.hpp

    --- Linking model ---
    g++ -Wno-deprecated-declarations -std=c++17 -pthread -D_REENTRANT -Wno-sign-compare -Wno-ignored-attributes -Wno-class-memaccess      -I stan/lib/stan_math/lib/tbb_2020.3/include    -O3 -I src -I stan/src -I stan/lib/rapidjson_1.1.0/ -I lib/CLI11-1.9.1/ -I stan/lib/stan_math/ -I stan/lib/stan_math/lib/eigen_3.4.0 -I stan/lib/stan_math/lib/boost_1.87.0 -I stan/lib/stan_math/lib/sundials_6.1.1/include -I stan/lib/stan_math/lib/sundials_6.1.1/src/sundials    -DBOOST_DISABLE_ASSERTS               -Wl,-L,"/home/runner/.cmdstan/cmdstan-2.38.0/stan/lib/stan_math/lib/tbb"   -Wl,-rpath,"/home/runner/.cmdstan/cmdstan-2.38.0/stan/lib/stan_math/lib/tbb"      /tmp/Rtmpwt5M8M/model-3af3211dcec4.o src/cmdstan/main.o       -ltbb   stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_nvecserial.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_cvodes.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_idas.a stan/lib/stan_math/lib/sundials_6.1.1/lib/libsundials_kinsol.a  stan/lib/stan_math/lib/tbb/libtbb.so.2 -o /tmp/Rtmpwt5M8M/model-3af3211dcec4
    rm /tmp/Rtmpwt5M8M/model-3af3211dcec4.o /tmp/Rtmpwt5M8M/model-3af3211dcec4.hpp
...
```
    ...
    Running ./bernoulli 'id=1' random 'seed=1376020223' data \
      'file=/tmp/Rtmpwt5M8M/standata-3af33610f344.json' output \
      'file=/tmp/Rtmpwt5M8M/bernoulli-202604022138-1-1e164d.csv' \
      'profile_file=/tmp/Rtmpwt5M8M/bernoulli-profile-202604022138-1-3dce28.csv' \
    ...
    Chain 1 data 
    Chain 1   file = /tmp/Rtmpwt5M8M/standata-3af33610f344.json 
    Chain 1 init = 2 (Default) 
    Chain 1 random 
    Chain 1   seed = 1376020223 
    Chain 1 output 
    Chain 1   file = /tmp/Rtmpwt5M8M/bernoulli-202604022138-1-1e164d.csv 
    Chain 1   diagnostic_file =  (Default) 
    Chain 1   refresh = 100 (Default) 
    Chain 1   sig_figs = 8 (Default) 
    Chain 1   profile_file = /tmp/Rtmpwt5M8M/bernoulli-profile-202604022138-1-3dce28.csv 
