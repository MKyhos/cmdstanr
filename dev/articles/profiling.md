...
```
    ...
    1     priors 139978785843008 0.003734565  0.002757309  0.000977256       34904
    2 likelihood 139978785843008 0.664932590  0.516514620  0.148417970       52356
...
```
    ...
    [[1]]
            name       thread_id  total_time forward_time reverse_time chain_stack
    1     priors 140492231620416 0.003640539  0.002613106  0.001027433       34214
    2 likelihood 140492231620416 0.435432140  0.434286830  0.001145314       51321
      no_chain_stack autodiff_calls no_autodiff_calls
    1          34214          17107                 1
    2          17107          17107                 1
...
```
    ...
    [1] "/tmp/RtmpHILQkH/model_580e4657b49f155a37081bdfaae83f92-profile-202604022139-1-806b17.csv"
